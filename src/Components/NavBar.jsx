...
let count = useContext(cartValue) 
  return (
    <div className='w-screen h-[4rem] flex justify-between p-4 pr-12 items-end '>
        ...
        <div className='flex items-center justify-center gap-3 '>
            <p className='text-lg'>My Orders</p>
              <HiShoppingCart size={28} className='relative'/>
                 <p className='w-4 h-4 absolute right-11 md:right-9 top-4  grid place-items-center text-[0.6rem] bg-red-600 text-white rounded-full'>{count.cart}</p>
