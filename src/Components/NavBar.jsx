  ...
  return (
    <div className="w-screen h-[4rem] flex justify-between p-4 items-end  ">
      ...
      <div className="flex items-center justify-center gap-3 md:pr-5 ">
        ...
        <div className="relative w-7 h-7 items-center justify-center flex">
          <HiShoppingCart size={28} className="" />
          <p className="w-4 h-4 absolute left-4 -top-1 md:-top-1 md:left-4  grid place-items-center text-[0.6rem] bg-red-600 text-white rounded-full">
            {count.cart}
          </p>
        </div>
      </div>
